...
double lin_pos_sp_equality_tolerance_x_axis_left_arm_data = 0.025;
...
double force_to_apply_to_table_z_axis_right_arm_data = -15.0;
...
double lin_pos_sp_x_axis_left_arm_data = 0.7;
...
double abag_previous_adaptive_gain_signal_z_axis_right_arm_data = 0.0;
double abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data = 0.0;
double force_to_apply_to_table_z_axis_left_arm_data = -15.0;
      ...
      if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && ee_below_desired_height_left_arm_z_axis_flag && states_z_axis_left_arm_is_active) 
      {
        ...
        if (pos_constraint_left_arm_reached_desired_height_z_axis_flag && pos_constraint_right_arm_reached_desired_height_z_axis_flag) 
        {
          ...
          if (pos_constraint_ee_below_desired_height_left_arm_z_axis_event) {
            ...
            set_value_of_first_to_second_variable(&abag_filtered_error_signal_z_axis_right_arm_data, &abag_previous_error_signal_z_axis_left_arm_data);
