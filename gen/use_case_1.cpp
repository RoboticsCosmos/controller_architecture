...
int main()
{
  ...
  bool i_term_lower_than_upper_saturation_limit_z_axis_left_arm_event = false;
  ...
  bool i_term_greater_than_lower_saturation_limit_z_axis_left_arm_event = false;
  ...
  bool i_term_lower_than_upper_saturation_limit_z_axis_right_arm_event = false;
  ...
  double i_term_saturation_upper_limit_z_axis_left_arm_data = 0.5;
  double i_term_saturation_upper_limit_z_axis_right_arm_data = 0.5;
  double i_term_saturation_lower_limit_z_axis_right_arm_data = -0.5;
  double i_term_saturation_lower_limit_z_axis_left_arm_data = -0.5;
  ...
  bool i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event = false;
  ...
  double zero_lin_vel_error_z_axis_right_arm_data = 0.0;
  ...
  bool i_term_greater_than_lower_saturation_limit_z_axis_right_arm_event = false;
  double pd_term_summation_z_axis_left_arm_data = 0.0;
  ...
  double p_gain_z_axis_right_arm_data = 200.0;
  double i_gain_lin_vel_z_axis_right_arm_data = 300.0;
  double d_gain_lin_vel_z_axis_right_arm_data = 3.;
  ...
  bool i_term_lower_than_eq_to_lower_saturation_limit_z_axis_right_arm_event = false;
  ...
  bool vel_error_is_negative_z_axis_right_arm_event = false;
  ...
  double previous_lin_vel_error_z_axis_right_arm_data = -0.0;
  double force_to_apply_to_table_z_axis_left_arm_data = -5.0;
  bool vel_error_is_positive_z_axis_right_arm_event = false;
  bool pos_out_of_tolerance_about_setpoint_y_axis_right_arm_event = false;
  bool vel_error_is_positive_z_axis_left_arm_event = false;
  ...
  bool i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event = false;
  ...
  bool i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event = false;
  ...
  double p_term_calculator_lin_pos_y_axis_left_arm_data = 0.0;
  double lin_pos_sp_equality_tolerance_y_axis_left_arm_data = 0.02;
  double stiffness_damping_terms_summation_z_axis_right_arm_data = 0.0;
  ...
  bool vel_error_is_negative_z_axis_left_arm_event = false;
  ...
  double stiffness_damping_terms_summation_z_axis_left_arm_data = 0.0;
  ...
  double p_term_calculator_lin_pos_y_axis_right_arm_data = 0.0;
  double previous_lin_vel_error_z_axis_left_arm_data = 0.0;
  double measured_lin_pos_x_axis_right_arm_data = 0.0;
  double pd_term_summation_z_axis_right_arm_data = 0.0;
  double zero_lin_vel_error_z_axis_left_arm_data = 0.0;
  bool error_within_threshold_to_activate_i_block_z_axis_left_arm_event = false;
  double lin_vel_sp_threshold_to_activate_i_z_axis_left_arm_data = 0.005;
    ...
    if (states_z_axis_right_arm_is_active)
    {
      ...
      if (pos_constraint_arm_above_uncertain_contact_region_z_axis_right_arm_flag && states_z_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (error_outside_threshold_to_deactivate_i_block_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PD_CONTROLLER;
            ...
            summation2(&p_term_lin_vel_z_axis_right_arm_data, &d_term_lin_vel_z_axis_right_arm_data, &pd_term_summation_z_axis_right_arm_data);

            summation2(&pd_term_summation_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);
          ...
          greater_than_monitor(&i_term_lin_vel_z_axis_right_arm_data, &i_term_saturation_lower_limit_z_axis_right_arm_data, &i_term_greater_than_lower_saturation_limit_z_axis_right_arm_event);

          less_than_monitor(&i_term_lin_vel_z_axis_right_arm_data, &i_term_saturation_upper_limit_z_axis_right_arm_data, &i_term_lower_than_upper_saturation_limit_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_to_activate_i_block_z_axis_right_arm_event &&
              i_term_greater_than_lower_saturation_limit_z_axis_right_arm_event &&
              i_term_lower_than_upper_saturation_limit_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_right_arm_data, &measured_lin_vel_z_axis_right_arm_data, &lin_vel_error_pid_z_axis_right_arm_data);
            ...
            summation2(&pid_term_summation_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);

            // set all flags in the schedule to false
            error_within_threshold_to_activate_i_block_z_axis_right_arm_event = false;
            i_term_greater_than_lower_saturation_limit_z_axis_right_arm_event = false;
            i_term_lower_than_upper_saturation_limit_z_axis_right_arm_event = false;
          }
          less_than_equal_to_monitor(&i_term_lin_vel_z_axis_right_arm_data, &i_term_saturation_lower_limit_z_axis_right_arm_data, &i_term_lower_than_eq_to_lower_saturation_limit_z_axis_right_arm_event);

          less_than_monitor(&lin_vel_error_pid_z_axis_right_arm_data, &zero_lin_vel_error_z_axis_right_arm_data, &vel_error_is_negative_z_axis_right_arm_event);

          in_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_right_arm_data, &error_within_threshold_to_activate_i_block_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (i_term_lower_than_eq_to_lower_saturation_limit_z_axis_right_arm_event &&
              vel_error_is_negative_z_axis_right_arm_event &&
              error_within_threshold_to_activate_i_block_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_CONTROLLER_CLAMPED;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_right_arm_data, &measured_lin_vel_z_axis_right_arm_data, &lin_vel_error_pid_z_axis_right_arm_data);
            ...
            // set all flags in the schedule to false
            i_term_lower_than_eq_to_lower_saturation_limit_z_axis_right_arm_event = false;
            vel_error_is_negative_z_axis_right_arm_event = false;
            error_within_threshold_to_activate_i_block_z_axis_right_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_right_arm_data, &error_within_threshold_to_activate_i_block_z_axis_right_arm_event);

          greater_than_equal_to_monitor(&i_term_lin_vel_z_axis_right_arm_data, &i_term_saturation_upper_limit_z_axis_right_arm_data, &i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event);
          ...
          if (error_within_threshold_to_activate_i_block_z_axis_right_arm_event &&
              i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event &&
              vel_error_is_negative_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
            ...
            // set all flags in the schedule to false
            error_within_threshold_to_activate_i_block_z_axis_right_arm_event = false;
            i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event = false;
            vel_error_is_negative_z_axis_right_arm_event = false;
          }
          greater_than_equal_to_monitor(&i_term_lin_vel_z_axis_right_arm_data, &i_term_saturation_upper_limit_z_axis_right_arm_data, &i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event);

          greater_than_equal_to_monitor(&lin_vel_error_pid_z_axis_right_arm_data, &zero_lin_vel_error_z_axis_right_arm_data, &vel_error_is_positive_z_axis_right_arm_event);

          in_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_right_arm_data, &error_within_threshold_to_activate_i_block_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event &&
              vel_error_is_positive_z_axis_right_arm_event &&
              error_within_threshold_to_activate_i_block_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_CONTROLLER_CLAMPED;
            // execute all functions in the trigger chain
            ...
            // set all flags in the schedule to false
            i_term_greater_than_eq_to_upper_saturation_limit_z_axis_right_arm_event = false;
            vel_error_is_positive_z_axis_right_arm_event = false;
            error_within_threshold_to_activate_i_block_z_axis_right_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_right_arm_data, &error_within_threshold_to_activate_i_block_z_axis_right_arm_event);
          ...
          if (error_within_threshold_to_activate_i_block_z_axis_right_arm_event &&
              i_term_lower_than_eq_to_lower_saturation_limit_z_axis_right_arm_event &&
              vel_error_is_positive_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
      ...
      if (pos_constraint_arm_in_uncertain_contact_region_z_axis_right_arm_flag && pos_constraint_arm_above_pos_sp_z_axis_right_arm_flag && states_z_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_constraint_arm_in_uncertain_contact_region_z_axis_right_arm_event &&
              pos_constraint_arm_above_pos_sp_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::IMPEDANCE_CONTROLLER;
            // execute all functions in the trigger chain
            ...
            summation2(&stiffness_term_lin_z_axis_right_arm_data, &damping_term_z_axis_right_arm_data, &stiffness_damping_terms_summation_z_axis_right_arm_data);

            summation2(&stiffness_damping_terms_summation_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);
      ...
      if (true && states_x_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_right_arm_event)
          {
            ...
            summation2(&p_term_calculator_lin_pos_x_axis_right_arm_data, &apply_ee_force_x_axis_right_arm_data, &apply_ee_force_x_axis_right_arm_data);
      ...
      if (true && states_y_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_y_axis_right_arm_event)
          {
            ...
            multiply2(&p_gain_pos_y_axis_right_arm_data, &lin_pos_error_y_axis_right_arm_data, &p_term_calculator_lin_pos_y_axis_right_arm_data);

            summation2(&p_term_calculator_lin_pos_y_axis_right_arm_data, &apply_ee_force_y_axis_right_arm_data, &apply_ee_force_y_axis_right_arm_data);
    ...
    if (states_z_axis_left_arm_is_active)
    {
      ...
      if (pos_constraint_arm_above_uncertain_contact_region_z_axis_left_arm_flag && states_z_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (error_outside_threshold_to_deactivate_i_block_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PD_CONTROLLER;
            // execute all functions in the trigger chain
            ...
            summation2(&p_term_lin_vel_z_axis_left_arm_data, &d_term_lin_vel_z_axis_left_arm_data, &pd_term_summation_z_axis_left_arm_data);

            summation2(&pd_term_summation_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);

            // set all flags in the schedule to false
            error_outside_threshold_to_deactivate_i_block_z_axis_left_arm_event = false;
          }
          less_than_equal_to_monitor(&i_term_lin_vel_z_axis_left_arm_data, &i_term_saturation_lower_limit_z_axis_left_arm_data, &i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event);

          less_than_monitor(&lin_vel_error_pid_z_axis_left_arm_data, &zero_lin_vel_error_z_axis_left_arm_data, &vel_error_is_negative_z_axis_left_arm_event);
          ...
          if (i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event &&
              vel_error_is_negative_z_axis_left_arm_event &&
              error_within_threshold_to_activate_i_block_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_CONTROLLER_CLAMPED;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data);
            ...
            summation2(&pid_term_summation_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);

            // set all flags in the schedule to false
            i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event = false;
            vel_error_is_negative_z_axis_left_arm_event = false;
            error_within_threshold_to_activate_i_block_z_axis_left_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_left_arm_data, &lin_vel_sp_z_axis_left_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_left_arm_data, &error_within_threshold_to_activate_i_block_z_axis_left_arm_event);

          greater_than_equal_to_monitor(&i_term_lin_vel_z_axis_left_arm_data, &i_term_saturation_upper_limit_z_axis_left_arm_data, &i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event);

          less_than_monitor(&lin_vel_error_pid_z_axis_left_arm_data, &zero_lin_vel_error_z_axis_left_arm_data, &vel_error_is_negative_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_to_activate_i_block_z_axis_left_arm_event &&
              i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event &&
              vel_error_is_negative_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data);
            ...
            // set all flags in the schedule to false
            error_within_threshold_to_activate_i_block_z_axis_left_arm_event = false;
            i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event = false;
            vel_error_is_negative_z_axis_left_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_left_arm_data, &lin_vel_sp_z_axis_left_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_left_arm_data, &error_within_threshold_to_activate_i_block_z_axis_left_arm_event);
          ...
          greater_than_equal_to_monitor(&lin_vel_error_pid_z_axis_left_arm_data, &zero_lin_vel_error_z_axis_left_arm_data, &vel_error_is_positive_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_to_activate_i_block_z_axis_left_arm_event &&
              i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event &&
              vel_error_is_positive_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data);
            ...
            error_within_threshold_to_activate_i_block_z_axis_left_arm_event = false;
            i_term_lower_than_eq_to_lower_saturation_limit_z_axis_left_arm_event = false;
            vel_error_is_positive_z_axis_left_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_left_arm_data, &lin_vel_sp_z_axis_left_arm_data, &lin_vel_sp_threshold_to_activate_i_z_axis_left_arm_data, &error_within_threshold_to_activate_i_block_z_axis_left_arm_event);

          greater_than_monitor(&i_term_lin_vel_z_axis_left_arm_data, &i_term_saturation_lower_limit_z_axis_left_arm_data, &i_term_greater_than_lower_saturation_limit_z_axis_left_arm_event);

          less_than_monitor(&i_term_lin_vel_z_axis_left_arm_data, &i_term_saturation_upper_limit_z_axis_left_arm_data, &i_term_lower_than_upper_saturation_limit_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_to_activate_i_block_z_axis_left_arm_event &&
              i_term_greater_than_lower_saturation_limit_z_axis_left_arm_event &&
              i_term_lower_than_upper_saturation_limit_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_CONTROLLER;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data);
            ...
            // set all flags in the schedule to false
            error_within_threshold_to_activate_i_block_z_axis_left_arm_event = false;
            i_term_greater_than_lower_saturation_limit_z_axis_left_arm_event = false;
            i_term_lower_than_upper_saturation_limit_z_axis_left_arm_event = false;
          }
          greater_than_equal_to_monitor(&i_term_lin_vel_z_axis_left_arm_data, &i_term_saturation_upper_limit_z_axis_left_arm_data, &i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event);
          ...
          if (i_term_greater_than_eq_to_upper_saturation_limit_z_axis_left_arm_event &&
              vel_error_is_positive_z_axis_left_arm_event &&
              error_within_threshold_to_activate_i_block_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_CONTROLLER_CLAMPED;
      ...
      if (pos_constraint_arm_in_uncertain_contact_region_z_axis_left_arm_flag && pos_constraint_arm_above_pos_sp_z_axis_left_arm_flag && states_z_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_constraint_arm_in_uncertain_contact_region_z_axis_left_arm_event &&
              pos_constraint_arm_above_pos_sp_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::IMPEDANCE_CONTROLLER;
            // execute all functions in the trigger chain
            ...
            summation2(&stiffness_term_lin_z_axis_left_arm_data, &damping_term_z_axis_left_arm_data, &stiffness_damping_terms_summation_z_axis_left_arm_data);

            summation2(&stiffness_damping_terms_summation_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);
      ...
      if (true && states_x_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_left_arm_event)
          {
            ...
            summation2(&p_term_calculator_lin_pos_x_axis_left_arm_data, &apply_ee_force_x_axis_left_arm_data, &apply_ee_force_x_axis_left_arm_data);
      ...
      if (true && states_y_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_y_axis_left_arm_event)
          {
            ...
            multiply2(&p_gain_pos_y_axis_left_arm_data, &lin_pos_error_y_axis_left_arm_data, &p_term_calculator_lin_pos_y_axis_left_arm_data);

            summation2(&p_term_calculator_lin_pos_y_axis_left_arm_data, &apply_ee_force_y_axis_left_arm_data, &apply_ee_force_y_axis_left_arm_data);
