...
int main()
{
  ...
  double abag_saturation_of_bias_term_z_axis_left_arm_data = 0.0;
  double abag_saturation_upper_limit_z_axis_left_arm_data = 1.0;
  double abag_bias_adaptation_step_z_axis_right_arm_data = 0.5;
  double abs_distance_between_both_arms_y_axis_data = 0.0;
  double abag_control_command_signal_z_axis_right_arm_data = 0.0;
  double abag_previous_error_signal_z_axis_right_arm_data = 0.0;
  double abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data = 0.0;
  double lin_pos_sp_equality_tolerance_x_axis_left_arm_data = 0.02;
  double number_one_data = 1.0;
  double abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data = 0.0;
  double lin_pos_error_stiffness_z_axis_left_arm_data = 0.0;
  double abag_previous_adaptive_gain_signal_z_axis_left_arm_data = 0.0;
  double abag_saturation_upper_limit_z_axis_right_arm_data = 1.0;
  ...
  double abag_sign_of_error_z_axis_right_arm_data = 1.0;
  double abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_left_arm_data = 0.0;
  double abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_right_arm_data = 0.0;
  bool pos_constraint_not_equal_to_setpoint_z_axis_right_arm_event = false;
  double apply_ee_force_y_axis_right_arm_data = 0.0;
  double abag_previous_error_signal_z_axis_left_arm_data = 0.0;
  double lin_pos_sp_equality_tolerance_z_axis_right_arm_data = 0.001;
  double abag_error_signal_z_axis_left_arm_data = 0.0;
  double abag_alpha_minus_one_z_axis_left_arm_data = 0.0;
  double abag_difference_bias_and_scaled_error_z_axis_right_arm_data = 0.0;
  double force_to_apply_to_table_z_axis_right_arm_data = -5.0;
  double measured_lin_vel_x_axis_left_arm_data = 0.0;
  bool both_arms_grasped_box_y_axis_flag = false;
  ...
  double lin_pos_sp_tolerance_x_axis_left_arm_data = 0.02;
  ...
  double force_to_apply_inwards_y_axis_left_arm_data = -10.0;
  ...
  double abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_left_arm_data = 1.0;
  ...
  double abag_adaptive_gain_signal_z_axis_right_arm_data = 0.0;
  double force_to_apply_inwards_y_axis_right_arm_data = 19.0;
  ...
  double abag_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data = 0.0;
  double stiffness_lin_z_axis_right_arm_data = 100.0;
  double abag_product_bias_adaptation_step_hside_function_and_sign_of_error_difference_z_axis_right_arm_data = 0.0;
  ...
  double abag_alpha_error_sign_filtering_factor_z_axis_left_arm_data = 0.5;
  double abag_alpha_error_sign_filtering_factor_z_axis_right_arm_data = 0.5;
  double abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_right_arm_data = 1.0;
  double abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_right_arm_data = 0.0;
  ...
  double abag_gain_adaptation_step_z_axis_left_arm_data = 0.5;
  ...
  double p_gain_pos_x_axis_right_arm_data = 150.0;
  ...
  double abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_left_arm_data = 0.0;
  ...
  double abag_adaptive_gain_signal_z_axis_left_arm_data = 0.0;
  double apply_ee_force_y_axis_left_arm_data = 0.0;
  double abag_error_signal_z_axis_right_arm_data = 0.0;
  double abag_saturation_of_gain_z_axis_right_arm_data = 0.0;
  ...
  double abag_saturation_of_control_command_signal_z_axis_left_arm_data = 0.0;
  double abag_previous_adaptive_gain_signal_z_axis_right_arm_data = 0.0; // unused
  double abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data = 0.0;
  double force_to_apply_to_table_z_axis_left_arm_data = -5.0;
  double abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data = 0.0;
  bool pos_constraint_left_arm_reached_desired_height_z_axis_flag = false;
  double measured_lin_vel_x_axis_right_arm_data = 0.0;
  double abag_saturation_lower_limit_z_axis_right_arm_data = 0.0;
  bool pos_constraint_right_arm_reached_desired_height_z_axis_flag = false;
  double abag_adaptive_bias_signal_z_axis_left_arm_data = 0.0;
  ...
  double abag_error_threshold_for_bias_adaptation_signal_z_axis_left_arm_data = 0.3;
  double abag_saturation_of_control_command_z_axis_right_arm_data = 0.0;
  ...
  double lin_pos_sp_tolerance_x_axis_right_arm_data = 0.02;
  double measured_lin_pos_y_axis_right_arm_data = 0.0;
  double lin_pos_limit_to_avoid_collision_y_axis_data = 0.15;
  double lin_pos_table_height_z_axis_data = 0.03;
  ...
  double abag_saturation_of_control_command_z_axis_left_arm_data = 0.0;
  double p_gain_pos_x_axis_left_arm_data = 150.0;
  ...
  bool ee_below_desired_height_right_arm_z_axis_flag = false;
  bool pos_constraint_ee_below_desired_height_left_arm_z_axis_event = false;
  double abag_absolute_value_of_filtered_error_z_axis_right_arm_data = 0.0;
  double lin_pos_error_x_axis_left_arm_data = 0.0;
  double abag_sign_of_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data = 1.0;
  double abag_adaptive_bias_signal_z_axis_right_arm_data = 0.0;
  double abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data = 0.0;
  double abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data = 0.0;
  double abag_alpha_minus_one_z_axis_right_arm_data = 0.0;
  double abag_sign_of_error_z_axis_left_arm_data = 1.0;
  double abag_error_threshold_for_gain_adaptation_signal_z_axis_right_arm_data = 0.3;
  ...
  while (time_elapsed < task_time_out)
  {
    ...
    if (!states_z_axis_right_arm_is_active)
    {
      ...
      less_than_equal_to_monitor(&abs_distance_between_both_arms_y_axis_data, &width_of_box_data, &both_arms_grasped_box_y_axis_flag);

      in_interval_monitor(&measured_lin_pos_x_axis_right_arm_data, &lin_pos_sp_x_axis_right_arm_data, &lin_pos_sp_tolerance_x_axis_right_arm_data, &pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag);

      in_interval_monitor(&measured_lin_pos_x_axis_left_arm_data, &lin_pos_sp_x_axis_left_arm_data, &lin_pos_sp_tolerance_x_axis_left_arm_data, &pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag);

      less_than_equal_to_monitor(&measured_lin_pos_z_axis_right_arm_data, &lin_pos_sp_z_axis_right_arm_data, &ee_below_desired_height_right_arm_z_axis_flag);
      ...
      greater_than_monitor(&abs_distance_between_both_arms_y_axis_data, &width_of_box_data, &both_arms_not_grasped_box_y_axis_flag);
    ...
    if (states_z_axis_right_arm_is_active)
    {
      ...
      if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && ee_below_desired_height_right_arm_z_axis_flag && states_z_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          less_than_equal_to_monitor(&measured_lin_pos_z_axis_right_arm_data, &lin_pos_sp_z_axis_right_arm_data, &pos_constraint_ee_below_desired_height_right_arm_z_axis_event);
          ...
          if (pos_constraint_ee_below_desired_height_right_arm_z_axis_event)
          {
            ...
            controller_name_data_right_z = controller_name::ABAG_CONTROLLER;
            ...
            multiply2(&abag_alpha_error_sign_filtering_factor_z_axis_right_arm_data, &abag_previous_error_signal_z_axis_right_arm_data, &abag_product_alpha_by_previous_error_z_axis_right_arm_data);

            subtraction(&lin_vel_sp_z_axis_right_arm_data, &measured_lin_vel_z_axis_right_arm_data, &abag_error_signal_z_axis_right_arm_data);

            get_sign(&abag_error_signal_z_axis_right_arm_data, &abag_sign_of_error_z_axis_right_arm_data);

            multiply2(&abag_alpha_minus_one_z_axis_right_arm_data, &abag_sign_of_error_z_axis_right_arm_data, &abag_product_alpha_minus_one_by_sign_of_error_z_axis_right_arm_data);

            summation2(&abag_product_alpha_by_previous_error_z_axis_right_arm_data, &abag_product_alpha_minus_one_by_sign_of_error_z_axis_right_arm_data, &abag_filtered_error_signal_z_axis_right_arm_data);

            subtraction(&abag_filtered_error_signal_z_axis_right_arm_data, &abag_error_threshold_for_bias_adaptation_signal_z_axis_right_arm_data, &abag_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data);

            get_sign(&abag_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data, &abag_sign_of_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data);

            get_abs(&abag_filtered_error_signal_z_axis_right_arm_data, &abag_absolute_value_of_filtered_error_z_axis_right_arm_data);

            subtraction(&abag_absolute_value_of_filtered_error_z_axis_right_arm_data, &abag_error_threshold_for_bias_adaptation_signal_z_axis_right_arm_data, &abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data);

            hside(&abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data, &abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data);

            multiply3(&abag_bias_adaptation_step_z_axis_right_arm_data, &abag_sign_of_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data, &abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_right_arm_data, &abag_product_bias_adaptation_step_hside_function_and_sign_of_error_difference_z_axis_right_arm_data);

            summation2(&abag_previous_adaptive_bias_signal_z_axis_right_arm_data, &abag_product_bias_adaptation_step_hside_function_and_sign_of_error_difference_z_axis_right_arm_data, &abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_right_arm_data);

            saturation(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_right_arm_data, &abag_saturation_lower_limit_z_axis_right_arm_data, &abag_saturation_upper_limit_z_axis_right_arm_data);

            subtraction(&abag_absolute_value_of_filtered_error_z_axis_right_arm_data, &abag_error_threshold_for_gain_adaptation_signal_z_axis_right_arm_data, &abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_right_arm_data);

            get_sign(&abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_right_arm_data, &abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_right_arm_data);

            multiply2(&abag_gain_adaptation_step_z_axis_right_arm_data, &abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_right_arm_data, &abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_right_arm_data);

            summation2(&abag_previous_adaptive_gain_signal_z_axis_right_arm_data, &abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_right_arm_data, &abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data);

            std::cout
                << "abag_sum_previous_gain_and_increment_of_gain_z_axis_right_"
                   "arm_data: "
                << abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data
                << std::endl;

            saturation(&abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data, &abag_saturation_lower_limit_z_axis_right_arm_data, &abag_saturation_upper_limit_z_axis_right_arm_data);

            multiply2(&abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data, &abag_sign_of_error_z_axis_right_arm_data, &abag_product_gain_by_sign_of_error_z_axis_right_arm_data);

            subtraction(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_right_arm_data, &abag_product_gain_by_sign_of_error_z_axis_right_arm_data, &abag_difference_bias_and_scaled_error_z_axis_right_arm_data);

            saturation(&abag_difference_bias_and_scaled_error_z_axis_right_arm_data, &abag_saturation_lower_limit_z_axis_right_arm_data, &abag_saturation_upper_limit_z_axis_right_arm_data);

            multiply2(&abag_difference_bias_and_scaled_error_z_axis_right_arm_data, &abag_mapping_to_force_factor_data, &apply_ee_force_z_axis_right_arm_data);

            summation2(&apply_ee_force_z_axis_right_arm_data, &weight_of_box_data, &apply_ee_force_z_axis_right_arm_data);

            set_value_of_first_to_second_variable(&abag_filtered_error_signal_z_axis_right_arm_data, &abag_previous_error_signal_z_axis_right_arm_data);

            set_value_of_first_to_second_variable(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_right_arm_data, &abag_previous_adaptive_bias_signal_z_axis_right_arm_data);

            set_value_of_first_to_second_variable(&abag_sum_previous_gain_and_increment_of_gain_z_axis_right_arm_data, &abag_previous_adaptive_gain_signal_z_axis_right_arm_data);

            // set all flags in the schedule to false
            pos_constraint_ee_below_desired_height_right_arm_z_axis_event = false;
          }
        }
      }
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_arm_below_setpoint_contact_region_z_axis_right_arm_flag && both_arms_not_grasped_box_y_axis_flag && states_z_axis_right_arm_is_active)
      {
        // execute all functions in post condition
        less_than_equal_to_monitor(&abs_distance_between_both_arms_y_axis_data, &width_of_box_data, &both_arms_grasped_box_y_axis_flag);
        ...
        // check if post condition flags are true
        if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag)
        {
          states_z_axis_right_arm_is_active = false;
        }
        else
        {
          // loop through each schedule and execute corresponding function names in monitors key
          less_than_equal_to_monitor(&measured_lin_pos_z_axis_right_arm_data, &lin_pos_table_height_z_axis_data, &pos_constraint_arm_below_setpoint_contact_region_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (pos_constraint_arm_below_setpoint_contact_region_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::FORCE_CONTROLLER;
            // execute all functions in the trigger chain
      ...
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_right_arm_reached_desired_height_z_axis_flag && pos_constraint_left_arm_reached_desired_height_z_axis_flag && states_z_axis_right_arm_is_active)
      {
        // execute all functions in post condition
        // check if post condition flags are true
        if (false)
        ...
        {
          // loop through each schedule and execute corresponding function names in monitors key
          out_of_interval_monitor(&measured_lin_pos_z_axis_right_arm_data, &lin_pos_sp_z_axis_right_arm_data, &lin_pos_sp_equality_tolerance_z_axis_right_arm_data, &pos_constraint_not_equal_to_setpoint_z_axis_right_arm_event);
          ...
          {
            // execute all functions in the trigger chain
            controller_name_data_right_z = controller_name::STIFFNESS_CONTROLLER;
            ...
            summation2(&stiffness_term_lin_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);

            // set all flags in the schedule to false
            pos_constraint_not_equal_to_setpoint_z_axis_right_arm_event = false;
          }
        }
      }
    }
      ...
      if (true && states_x_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_right_arm_event)
          {
            ...
            multiply2(&p_gain_pos_x_axis_right_arm_data, &lin_pos_error_x_axis_right_arm_data, &p_term_lin_pos_x_axis_right_arm_data);

            summation2(&p_term_lin_pos_x_axis_right_arm_data, &apply_ee_force_x_axis_right_arm_data, &apply_ee_force_x_axis_right_arm_data);
    ...
    if (!states_y_axis_right_arm_is_active)
    {
      ...
      if (pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag)
      {
    ...
    if (states_y_axis_right_arm_is_active)
    {
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && states_y_axis_right_arm_is_active)
      {
        // execute all functions in post condition
        less_than_equal_to_monitor(&abs_distance_between_both_arms_y_axis_data, &lin_pos_limit_to_avoid_collision_y_axis_data, &pos_constraint_limit_on_both_arms_to_avoid_collison_y_axis_flag);

        // check if post condition flags are true
        if (pos_constraint_limit_on_both_arms_to_avoid_collison_y_axis_flag)
        {
        ...
        {
          // loop through each schedule and execute corresponding function names in monitors key
          in_interval_monitor(&measured_lin_pos_x_axis_right_arm_data, &lin_pos_sp_x_axis_right_arm_data, &lin_pos_sp_tolerance_x_axis_right_arm_data, &pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_event);

          in_interval_monitor(&measured_lin_pos_x_axis_left_arm_data, &lin_pos_sp_x_axis_left_arm_data, &lin_pos_sp_tolerance_x_axis_left_arm_data, &pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_event && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_event)
          {
            // execute all functions in the trigger chain
            set_value_of_first_to_second_variable(&force_to_apply_inwards_y_axis_right_arm_data, &apply_ee_force_y_axis_right_arm_data);

            // set all flags in the schedule to false
            pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_event = false;
            pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_event = false;
          }
        }
      }
    }
    ...
    if (!states_z_axis_left_arm_is_active)
    {
      ...
      less_than_equal_to_monitor(&measured_lin_pos_z_axis_left_arm_data, &lin_pos_sp_z_axis_left_arm_data, &ee_below_desired_height_left_arm_z_axis_flag);
    ...
    if (states_z_axis_left_arm_is_active)
    {
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && ee_below_desired_height_left_arm_z_axis_flag && states_z_axis_left_arm_is_active)
      {
        // execute all functions in post condition
        greater_than_monitor(&measured_lin_pos_z_axis_left_arm_data, &lin_pos_sp_z_axis_left_arm_data, &pos_constraint_left_arm_reached_desired_height_z_axis_flag);
        ...
        {
          // loop through each schedule and execute corresponding function names in monitors key
          less_than_equal_to_monitor(&measured_lin_pos_z_axis_left_arm_data, &lin_pos_sp_z_axis_left_arm_data, &pos_constraint_ee_below_desired_height_left_arm_z_axis_event);

          // check if all flags in the schedule are true

          if (pos_constraint_ee_below_desired_height_left_arm_z_axis_event)
          {
            // execute all functions in the trigger chain
            controller_name_data_left_z = controller_name::ABAG_CONTROLLER;
            subtraction(&abag_alpha_error_sign_filtering_factor_z_axis_left_arm_data, &number_one_data, &abag_alpha_minus_one_z_axis_left_arm_data);

            multiply2(&abag_alpha_error_sign_filtering_factor_z_axis_left_arm_data, &abag_previous_error_signal_z_axis_left_arm_data, &abag_product_alpha_by_previous_error_z_axis_left_arm_data);

            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &abag_error_signal_z_axis_left_arm_data);

            get_sign(&abag_error_signal_z_axis_left_arm_data, &abag_sign_of_error_z_axis_left_arm_data);

            multiply2(&abag_alpha_minus_one_z_axis_left_arm_data, &abag_sign_of_error_z_axis_left_arm_data, &abag_product_alpha_minus_one_by_sign_of_error_z_axis_left_arm_data);

            summation2(&abag_product_alpha_by_previous_error_z_axis_left_arm_data, &abag_product_alpha_minus_one_by_sign_of_error_z_axis_left_arm_data, &abag_filtered_error_signal_z_axis_left_arm_data);

            subtraction(&abag_filtered_error_signal_z_axis_left_arm_data, &abag_error_threshold_for_bias_adaptation_signal_z_axis_left_arm_data, &abag_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data);

            get_sign(&abag_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data, &abag_sign_of_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data);

            get_abs(&abag_filtered_error_signal_z_axis_left_arm_data, &abag_absolute_value_of_filtered_error_z_axis_left_arm_data);

            subtraction(&abag_absolute_value_of_filtered_error_z_axis_left_arm_data, &abag_error_threshold_for_bias_adaptation_signal_z_axis_left_arm_data, &abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data);

            hside(&abag_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data, &abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data);

            multiply3(&abag_bias_adaptation_step_z_axis_left_arm_data, &abag_sign_of_difference_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data, &abag_hside_of_difference_absolute_value_of_filtered_error_by_threshold_for_bias_adaptation_z_axis_left_arm_data, &abag_product_bias_adaptation_step_hside_function_and_sign_of_error_difference_z_axis_left_arm_data);

            summation2(&abag_previous_adaptive_bias_signal_z_axis_left_arm_data, &abag_product_bias_adaptation_step_hside_function_and_sign_of_error_difference_z_axis_left_arm_data, &abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_left_arm_data);

            saturation(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_left_arm_data, &abag_saturation_lower_limit_z_axis_left_arm_data, &abag_saturation_upper_limit_z_axis_left_arm_data);

            subtraction(&abag_absolute_value_of_filtered_error_z_axis_left_arm_data, &abag_error_threshold_for_gain_adaptation_signal_z_axis_left_arm_data, &abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_left_arm_data);

            get_sign(&abag_difference_absolute_value_of_filtered_error_by_threshold_for_gain_adaptation_z_axis_left_arm_data, &abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_left_arm_data);

            multiply2(&abag_gain_adaptation_step_z_axis_left_arm_data, &abag_sign_of_difference_of_absolute_value_of_filtered_error_and_threshold_for_gain_adaptation_z_axis_left_arm_data, &abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_left_arm_data);

            summation2(&abag_previous_adaptive_gain_signal_z_axis_left_arm_data, &abag_product_gain_adaptation_step_and_sign_of_error_difference_z_axis_left_arm_data, &abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data);

            saturation(&abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data, &abag_saturation_lower_limit_z_axis_left_arm_data, &abag_saturation_upper_limit_z_axis_left_arm_data);

            multiply2(&abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data, &abag_sign_of_error_z_axis_left_arm_data, &abag_product_gain_by_sign_of_error_z_axis_left_arm_data);

            subtraction(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_left_arm_data, &abag_product_gain_by_sign_of_error_z_axis_left_arm_data, &abag_difference_bias_and_scaled_error_z_axis_left_arm_data);

            saturation(&abag_difference_bias_and_scaled_error_z_axis_left_arm_data, &abag_saturation_lower_limit_z_axis_left_arm_data, &abag_saturation_upper_limit_z_axis_left_arm_data);

            multiply2(&abag_difference_bias_and_scaled_error_z_axis_left_arm_data, &abag_mapping_to_force_factor_data, &apply_ee_force_z_axis_left_arm_data);

            summation2(&apply_ee_force_z_axis_left_arm_data, &weight_of_box_data, &apply_ee_force_z_axis_left_arm_data);

            set_value_of_first_to_second_variable(&abag_filtered_error_signal_z_axis_left_arm_data, &abag_previous_error_signal_z_axis_left_arm_data);

            set_value_of_first_to_second_variable(&abag_sum_previous_bias_term_and_increment_of_bias_term_z_axis_left_arm_data, &abag_previous_adaptive_bias_signal_z_axis_left_arm_data);

            set_value_of_first_to_second_variable(&abag_sum_previous_gain_and_increment_of_gain_z_axis_left_arm_data, &abag_previous_adaptive_gain_signal_z_axis_left_arm_data);

            // set all flags in the schedule to false
            pos_constraint_ee_below_desired_height_left_arm_z_axis_event = false;
          }
        }
      }
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_arm_below_setpoint_contact_region_z_axis_left_arm_flag && both_arms_not_grasped_box_y_axis_flag && states_z_axis_left_arm_is_active)
      {
        // execute all functions in post condition
        less_than_equal_to_monitor(&abs_distance_between_both_arms_y_axis_data, &width_of_box_data, &both_arms_grasped_box_y_axis_flag);
        ...
        // check if post condition flags are true
        if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag)
        {
          states_z_axis_left_arm_is_active = false;
        }
        else
        {
          // loop through each schedule and execute corresponding function names in monitors key
          less_than_equal_to_monitor(&measured_lin_pos_z_axis_left_arm_data, &lin_pos_table_height_z_axis_data, &pos_constraint_arm_below_setpoint_contact_region_z_axis_left_arm_event);
          ...
          {
            // execute all functions in the trigger chain
            controller_name_data_left_z = controller_name::FORCE_CONTROLLER;
      ...
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_left_arm_reached_desired_height_z_axis_flag && pos_constraint_right_arm_reached_desired_height_z_axis_flag && states_z_axis_left_arm_is_active)
      {
        // execute all functions in post condition
        // check if post condition flags are true
        if (false)
        ...
        {
          // loop through each schedule and execute corresponding function names in monitors key
          out_of_interval_monitor(&measured_lin_pos_z_axis_left_arm_data, &lin_pos_sp_z_axis_left_arm_data, &lin_pos_sp_equality_tolerance_z_axis_left_arm_data, &pos_constraint_not_equal_to_setpoint_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (pos_constraint_not_equal_to_setpoint_z_axis_left_arm_event)
          {
            // execute all functions in the trigger chain
            controller_name_data_left_z = controller_name::STIFFNESS_CONTROLLER;
            ...
            summation2(&stiffness_term_lin_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);

            // set all flags in the schedule to false
            pos_constraint_not_equal_to_setpoint_z_axis_left_arm_event = false;
          }
        }
      }
    }
      ...
      if (true && states_x_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_left_arm_event)
          {
            ...
            multiply2(&p_gain_pos_x_axis_left_arm_data, &lin_pos_error_x_axis_left_arm_data, &p_term_lin_pos_x_axis_left_arm_data);

            summation2(&p_term_lin_pos_x_axis_left_arm_data, &apply_ee_force_x_axis_left_arm_data, &apply_ee_force_x_axis_left_arm_data);
    ...
    if (!states_y_axis_left_arm_is_active)
    {
      ...
      if (pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag)
      {
    ...
    if (states_y_axis_left_arm_is_active)
    {
      // for each motion spec node ...
      // if combination of pre-cond flags are true
      if (pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && states_y_axis_left_arm_is_active)
      {
        // execute all functions in post condition
        less_than_equal_to_monitor(&abs_distance_between_both_arms_y_axis_data, &lin_pos_limit_to_avoid_collision_y_axis_data, &pos_constraint_limit_on_both_arms_to_avoid_collison_y_axis_flag);
