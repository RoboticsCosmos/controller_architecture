...
int main()
{
  ...
  double lin_vel_sp_threshold_z_axis_left_arm_data = 0.02;
  ...
  double stiffness_term_calculator_lin_z_axis_right_arm_data = 0.0;
  ...
  double p_term_calculator_lin_pos_x_axis_left_arm_data = 0.0;
  double i_gain_high_times_error_lin_vel_z_axis_right_arm_data = 0.0;
  ...
  double i_gain_high_lin_vel_z_axis_right_arm_data = 100.0;
  double force_to_apply_inwards_y_axis_left_arm_data = -10.0;
  bool states_z_axis_left_arm_is_active = false;
  double p_gain_z_axis_left_arm_data = 100.0;
  double measured_lin_pos_y_axis_left_arm_data = 0.0;
  double i_gain_low_times_error_lin_vel_z_axis_left_arm_data = 0.0;
  double apply_ee_force_z_axis_left_arm_data = 0.0;
  double i_gain_low_lin_vel_z_axis_right_arm_data = 20.0;
  double force_to_apply_inwards_y_axis_right_arm_data = 18.0;
  ...
  double i_gain_high_times_error_lin_vel_z_axis_left_arm_data = 0.0;
  ...
  double p_gain_pos_x_axis_right_arm_data = 200.0;
  double measured_lin_vel_z_axis_right_arm_data = 0.0;
  double i_gain_high_lin_vel_z_axis_left_arm_data = 100.0;
  bool error_outside_threshold_z_axis_right_arm_event = false;
  ...
  double stiffness_term_calculator_lin_z_axis_left_arm_data = 0.0;
  double apply_ee_force_y_axis_left_arm_data = 0.0;
  double pid_term_summation_z_axis_left_arm_data = 0.0;
  double lin_vel_sp_equality_tolerance_z_axis_left_arm_data = 0.005;
  bool error_outside_threshold_z_axis_left_arm_event = false;
  bool pos_constraint_arm_below_setpoint_contact_region_z_axis_left_arm_event = false;
  double i_gain_low_lin_vel_z_axis_left_arm_data = 20.0;
  double i_gain_low_times_error_lin_vel_z_axis_right_arm_data = 0.0;
  ...
  bool error_within_threshold_z_axis_right_arm_event = false;
  ...
  double lin_vel_sp_threshold_z_axis_right_arm_data = 0.02;
  ...
  double p_term_calculator_lin_pos_x_axis_right_arm_data = 0.0;
  double i_term_saturation_lower_limit_z_axis_left_arm_data = -5.0;
  double d_gain_lin_vel_z_axis_left_arm_data = 2.5;
  double pid_term_summation_z_axis_right_arm_data = 0.0;
  double p_gain_z_axis_right_arm_data = 100.0;
  double p_gain_pos_x_axis_left_arm_data = 200.0;
  ...
  bool error_within_threshold_z_axis_left_arm_event = false;
  ...
  while (time_elapsed < task_time_out)
  {
    ...
    if (states_z_axis_right_arm_is_active)
    {
      ...
      if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && ee_below_desired_height_right_arm_z_axis_flag && states_z_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          out_of_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_z_axis_right_arm_data, &error_outside_threshold_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (error_outside_threshold_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_LOW_I_GAIN;
            ...
            multiply2(&i_gain_low_lin_vel_z_axis_right_arm_data, &lin_vel_error_pid_z_axis_right_arm_data, &i_gain_low_times_error_lin_vel_z_axis_right_arm_data);

            integrator(&time_period_of_complete_controller_cycle_data, &i_gain_low_times_error_lin_vel_z_axis_right_arm_data, &i_term_lin_vel_z_axis_right_arm_data);
            ...
            summation3(&p_term_lin_vel_z_axis_right_arm_data, &i_term_lin_vel_z_axis_right_arm_data, &d_term_lin_vel_z_axis_right_arm_data, &pid_term_summation_z_axis_right_arm_data);

            summation2(&apply_ee_force_z_axis_right_arm_data, &pid_term_summation_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);
            ...
            error_outside_threshold_z_axis_right_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_right_arm_data, &lin_vel_sp_z_axis_right_arm_data, &lin_vel_sp_threshold_z_axis_right_arm_data, &error_within_threshold_z_axis_right_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_z_axis_right_arm_event)
          {
            controller_name_data_right_z = controller_name::PID_HIGH_I_GAIN;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_right_arm_data, &measured_lin_vel_z_axis_right_arm_data, &lin_vel_error_pid_z_axis_right_arm_data);
            ...
            multiply2(&i_gain_high_lin_vel_z_axis_right_arm_data, &lin_vel_error_pid_z_axis_right_arm_data, &i_gain_high_times_error_lin_vel_z_axis_right_arm_data);

            integrator(&time_period_of_complete_controller_cycle_data, &i_gain_high_times_error_lin_vel_z_axis_right_arm_data, &i_term_lin_vel_z_axis_right_arm_data);
            ...
            // set all flags in the schedule to false
            error_within_threshold_z_axis_right_arm_event = false;
          }
        }
      }
      // for each motion spec node ...
      ...
      if (pos_constraint_right_arm_reached_desired_height_z_axis_flag && pos_constraint_left_arm_reached_desired_height_z_axis_flag && states_z_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_constraint_not_equal_to_setpoint_z_axis_right_arm_event)
          {
            ...
            multiply2(&stiffness_lin_z_axis_right_arm_data, &lin_pos_error_stiffness_z_axis_right_arm_data, &stiffness_term_calculator_lin_z_axis_right_arm_data);

            summation2(&apply_ee_force_z_axis_right_arm_data, &stiffness_term_calculator_lin_z_axis_right_arm_data, &apply_ee_force_z_axis_right_arm_data);
      ...
      if (true && states_x_axis_right_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_right_arm_event)
          {
            ...
            multiply2(&p_gain_pos_x_axis_right_arm_data, &lin_pos_error_x_axis_right_arm_data, &p_term_calculator_lin_pos_x_axis_right_arm_data);

            summation2(&apply_ee_force_x_axis_right_arm_data, &p_term_calculator_lin_pos_x_axis_right_arm_data, &apply_ee_force_x_axis_right_arm_data);
    ...
    if (states_z_axis_left_arm_is_active)
    {
      ...
      if (both_arms_grasped_box_y_axis_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_left_arm_flag && pos_constraint_arm_within_tolerance_of_sp_x_axis_right_arm_flag && ee_below_desired_height_left_arm_z_axis_flag && states_z_axis_left_arm_is_active)
      {
        ...
        {
          // loop through each schedule and execute corresponding function names in monitors key
          out_of_interval_monitor(&measured_lin_vel_z_axis_left_arm_data, &lin_vel_sp_z_axis_left_arm_data, &lin_vel_sp_threshold_z_axis_left_arm_data, &error_outside_threshold_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (error_outside_threshold_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_LOW_I_GAIN;
            // execute all functions in the trigger chain
            ...
            multiply2(&i_gain_low_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data, &i_gain_low_times_error_lin_vel_z_axis_left_arm_data);

            integrator(&time_period_of_complete_controller_cycle_data, &i_gain_low_times_error_lin_vel_z_axis_left_arm_data, &i_term_lin_vel_z_axis_left_arm_data);
            ...
            summation3(&p_term_lin_vel_z_axis_left_arm_data, &i_term_lin_vel_z_axis_left_arm_data, &d_term_lin_vel_z_axis_left_arm_data, &pid_term_summation_z_axis_left_arm_data);

            summation2(&apply_ee_force_z_axis_left_arm_data, &pid_term_summation_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);

            summation2(&apply_ee_force_z_axis_left_arm_data, &weight_of_box_data, &apply_ee_force_z_axis_left_arm_data);

            // set all flags in the schedule to false
            error_outside_threshold_z_axis_left_arm_event = false;
          }
          in_interval_monitor(&measured_lin_vel_z_axis_left_arm_data, &lin_vel_sp_z_axis_left_arm_data, &lin_vel_sp_threshold_z_axis_left_arm_data, &error_within_threshold_z_axis_left_arm_event);

          // check if all flags in the schedule are true

          if (error_within_threshold_z_axis_left_arm_event)
          {
            controller_name_data_left_z = controller_name::PID_HIGH_I_GAIN;
            // execute all functions in the trigger chain
            subtraction(&lin_vel_sp_z_axis_left_arm_data, &measured_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data);
            ...
            multiply2(&i_gain_high_lin_vel_z_axis_left_arm_data, &lin_vel_error_pid_z_axis_left_arm_data, &i_gain_high_times_error_lin_vel_z_axis_left_arm_data);

            integrator(&time_period_of_complete_controller_cycle_data, &i_gain_high_times_error_lin_vel_z_axis_left_arm_data, &i_term_lin_vel_z_axis_left_arm_data);
            ...
            // set all flags in the schedule to false
            error_within_threshold_z_axis_left_arm_event = false;
          }
        }
      }
      // for each motion spec node ...
      ...
      if (pos_constraint_left_arm_reached_desired_height_z_axis_flag && pos_constraint_right_arm_reached_desired_height_z_axis_flag && states_z_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_constraint_not_equal_to_setpoint_z_axis_left_arm_event)
          {
            ...
            multiply2(&stiffness_lin_z_axis_left_arm_data, &lin_pos_error_stiffness_z_axis_left_arm_data, &stiffness_term_calculator_lin_z_axis_left_arm_data);

            summation2(&apply_ee_force_z_axis_left_arm_data, &stiffness_term_calculator_lin_z_axis_left_arm_data, &apply_ee_force_z_axis_left_arm_data);
      ...
      if (true && states_x_axis_left_arm_is_active)
      {
        ...
        else
        {
          ...
          if (pos_out_of_tolerance_about_setpoint_x_axis_left_arm_event)
          {
            ...
            multiply2(&p_gain_pos_x_axis_left_arm_data, &lin_pos_error_x_axis_left_arm_data, &p_term_calculator_lin_pos_x_axis_left_arm_data);

            summation2(&apply_ee_force_x_axis_left_arm_data, &p_term_calculator_lin_pos_x_axis_left_arm_data, &apply_ee_force_x_axis_left_arm_data);
